...
namespace DocumentTest\Form;

use Document\Form\ContactForm;
/**
...
class ContactFormTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInputFilterIsSet()
    {
        ...
        $sm = \DocumentTest\Bootstrap::getServiceManager();
        $formManager = $sm->get('FormElementManager');
        $inputFilter2 = $formManager->get('Document\Form\ContactForm')->getInputFilter();
    ...
    public function testInputFilterValidate()
    {
        ...
        $sm = \DocumentTest\Bootstrap::getServiceManager();
        $formManager = $sm->get('FormElementManager');
        $inputFilter = $formManager->get('Document\Form\ContactForm')->getInputFilter();
        $inputFilter->setData($data);
        $this->assertFalse($inputFilter->isValid());
    }
    public function testDi()
    {
        $di = \DocumentTest\Bootstrap::getServiceManager()->get('Di');
    ...
    public function testFormElementManger()
    {
        $sm = \DocumentTest\Bootstrap::getServiceManager();
        $formManager = $sm->get('FormElementManager');
        $this->assertTrue($formManager->has('Document\Form\ContactForm'));
    }
